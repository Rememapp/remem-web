...
export const features: Feature[] = [
    ...
    },
    {
        ...
        description: 'Data get encrypted on your device, then uploaded to your own Google Drive — never to our servers.',
        channel: 'memory',
    ...
    },
    {
        ...
        id: 'control.review',
        title: 'Manual review',
        description: 'Every AI suggestions is filled instantly, but you can review, edit or skip them before submitting.',
        channel: 'control',
        visual: ['12 matches found', '3 filled with AI', 'Ready for your review'],
    },
    {
